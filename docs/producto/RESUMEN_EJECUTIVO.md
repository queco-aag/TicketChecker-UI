...
- **[API_ENDPOINTS.md](../api/API_ENDPOINTS.md)** - Referencia completa de endpoints con ejemplos
- **[ADAPTACION_API.md](../migracion/ADAPTACION_API.md)** - Detalles técnicos de los cambios
- **[INTEGRACION_COMPLETADA.md](../migracion/INTEGRACION_COMPLETADA.md)** - Checklist completo
